package fun.night_gaming.outer.outer;
...
public class WearMapsActivity extends WearableActivity implements OnMapReadyCallback {
    ...
    public void onCreate(Bundle savedState) {
        ...
        setContentView(R.layout.activity_wear_maps);
